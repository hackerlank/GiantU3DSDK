...
//			setContentView(CommonUtil.getLayoutId(this,resName));
//		}
//		catch (Exception e)
//		{
...
//		__InitButton();
		m_contextAct = this;
		Log.d(TAG,"UserAvatarActivity!!!!!");
		if(m_bCreated) return;
		__InitParamFormUnity();


		CommonUtil.ENUM_RESULT eResult = CommonUtil.ENUM_RESULT.eResult_Picture;
	...
	private void __InitButton()
	{
	    ...
	    try 
	    {
			...
			m_btnOpenCamera = (Button) findViewById(CommonUtil.getId(this,"btnOpenCamrea"));
			resName = "btnGetPicture";
			//m_GetPictureID = R.id.class.getDeclaredField(resName).getInt(R.id.class);
			m_btnGetPicture = (Button) findViewById(CommonUtil.getId(this,"btnGetPicture"));
			resName = "btnCancel";
			//m_CancelID = R.id.class.getDeclaredField(resName).getInt(R.id.class);
			m_btnCancel = (Button) findViewById(CommonUtil.getId(this,"btnCancel"));
		} 
	    catch (Exception e)
		{
			// TODO Auto-generated catch block
